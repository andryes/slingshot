    ...
    <section class="con-hero">
        ...
        <div class="con-hero-inner">
            <div class="con-hero-content">
                ...
                <p class="con-hero-subtext"><?php echo esc_html( slingshot_lp_setting( $opt, 'con_hero_subtext', 'We bring deep technical expertise, cross-functional teams, and product thinking to every engagement — so you get outcomes, not just output.' ) ); ?></p>
