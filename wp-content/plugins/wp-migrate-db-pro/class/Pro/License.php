...
class License
{
	...
	function ajax_check_licence()
	{
		...
		$licence          = 'WEADOWN000000005603B1EBE59708542';
	...
	function ajax_activate_licence()
	{
		...
		$args = array(
			'licence_key' => urlencode( 'WEADOWN000000005603B1EBE59708542' ),
		...
		$this->set_licence_key( 'WEADOWN000000005603B1EBE59708542' );
		$decoded_response['masked_licence'] = $this->util->mask_licence( 'WEADOWN000000005603B1EBE59708542' );
	...
	{
		return 'WEADOWN000000005603B1EBE59708542';
	}
	...
	function set_licence_key( $key )
	{
		...
		update_user_meta( get_current_user_id(), Helpers::USER_LICENCE_META_KEY, 'WEADOWN000000005603B1EBE59708542' );
	}
	...
	public function set_global_licence_key( $key ) {
		$this->settings['licence'] = 'WEADOWN000000005603B1EBE59708542';
	...
	{
		return json_decode( $this->check_licence( 'WEADOWN000000005603B1EBE59708542' ), true );
