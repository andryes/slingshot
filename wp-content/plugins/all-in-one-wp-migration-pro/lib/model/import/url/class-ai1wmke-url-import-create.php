...
class Ai1wmke_URL_Import_Create {

	public static function execute( $params, $url = null ) {

		// Set progress
		Ai1wm_Status::info( __( 'Connecting to URL...', AI1WMKE_PLUGIN_NAME ) );
		...
		// Set URL client
		if ( is_null( $url ) ) {
			$url = new Ai1wmke_URL_Client( $params['file_url'] );
		}
		...
		// Set progress
		Ai1wm_Status::info( __( 'Done connecting to URL.', AI1WMKE_PLUGIN_NAME ) );
